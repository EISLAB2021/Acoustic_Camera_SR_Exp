...
def compress_image(input_path, output_path, quality=''):
    """
    Compresses a single acoustic camera image for quality loss testing.
...
def process_folder(input_folder, output_folder, quality=None):
    """
    Processes acoustic raw files to image format JPEG
...
if __name__ == "__main__":
    ...
    quality = 20  # Compression quality of acoustic camera images, range (0-100)
